...
(if (not pxdisplay-sym)
    (setq pxdisplay-sym
	  '((Forex_Major (EUR_USD USD_JPY GBP_USD USD_CHF USD_CAD AUD_USD NZD_USD))
	    ...
	    (Indicies (US30_USD SPX500_USD UK100_GBP JP225_USD EU50_EUR DE30_EUR
				AU200_AUD SG30_SGD TWIX_USD HK33_HKD CN50_USD
				IN50_USD))
	    (Commodities (XAU_USD XAG_USD XCU_USD BCO_USD NATGAS_USD
